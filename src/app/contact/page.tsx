    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
          <div className="overflow-hidden rounded-3xl border border-slate-200/60 bg-white p-6 sm:p-10 shadow-sm">
              ...
              {!isSuccess ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <input 
                      ...
                      placeholder="例）山田 太郎"
                      className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3.5 text-sm text-slate-800 outline-none transition-all focus:border-brand-primary focus:ring-4 focus:ring-indigo-50 focus:bg-white placeholder-slate-400 font-semibold"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-2">
                      お問い合わせ内容 / ご相談事項 <span className="text-rose-500 ml-1">*</span>
                    </label>
                    <textarea 
                      required
                      rows={5}
                      ...
                      maxLength={5000}
                      className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3.5 text-sm text-slate-800 outline-none transition-all focus:border-brand-primary focus:ring-4 focus:ring-indigo-50 focus:bg-white resize-y placeholder-slate-400 font-semibold leading-relaxed"
                    ></textarea>
                  </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-extrabold text-slate-900">送信が完了いたしました</h3>
